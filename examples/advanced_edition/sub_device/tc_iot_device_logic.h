...
#define TC_IOT_PROP_param_number 1
#define TC_IOT_PROP_param_enum 2
...
#define TC_IOT_PROP_param_enum_enum_0 0
#define TC_IOT_PROP_param_enum_enum_1 1
#define TC_IOT_PROP_param_enum_enum_2 2
